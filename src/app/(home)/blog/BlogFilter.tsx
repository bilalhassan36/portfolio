/**
 * @file BlogFilter.tsx
 * @description Provides a cohesive filtering interface for the blog, including category selection
 * pills and a text-based search input.
 * @dependencies
        ...
        <div className="group relative w-full md:w-64">
          ...
          {searchQuery && (
            <button
              ...
              // The "Clear" button gets a specific dark mode hover state to ensure the red doesn't clash or disappear
