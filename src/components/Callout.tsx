...
export const Callout = ({ data, className }: Props) => {
  ...
  if (data?.variant === "sidebar") {
    return (
      <div
        className={cn(
          "reveal-item bg-foreground text-background relative overflow-hidden rounded-2xl p-6 text-center",
          className
        )}
      >
        <div
        ...
        <div className="mx-auto max-w-5xl">
          <div className="bg-foreground text-background relative overflow-hidden rounded-[2.5rem] border border-white/5 px-6 py-12 text-center md:rounded-[3rem] md:px-16 md:py-20">
            ...
            <div className="reveal-item relative z-10 flex flex-col items-center">
              ...
              <h2 className="reveal-item mb-4 text-2xl leading-tight font-black tracking-tight text-white sm:text-3xl md:text-5xl">
              ...
              <p className="reveal-item mb-8 max-w-md text-sm leading-relaxed font-medium text-white/70 md:text-base">
                {data?.copy ||
