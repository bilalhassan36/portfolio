  ...
  return (
    <RevealWrapper asChild>
      <div className="mb-10 flex cursor-default flex-col items-center gap-3 text-center">
        <h2 className="reveal-item text-foreground max-w-xl text-3xl leading-tight font-extrabold tracking-tight sm:text-4xl md:text-5xl">
          {data.titleSimple}{" "}
          <span className="text-brand">{data.titleHighlight}</span>
        </h2>
        {/* Optional supporting text */}
        <p className="reveal-item text-clay mx-auto max-w-lg text-sm leading-relaxed sm:text-base md:text-lg">
          {data.supportingText}
        </p>
      </div>
    </RevealWrapper>
